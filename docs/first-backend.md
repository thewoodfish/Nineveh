...
Open Studio and sign in with GitHub.
...
them. Within a few seconds it reads *following the chain*, and `new_block_event` fills
at roughly two hundred rows a second.
